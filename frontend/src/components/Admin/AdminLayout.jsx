  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        ...
        <div className={`${responsive.container}`}>
          <div className={`flex justify-between items-center ${responsive.headerHeight}`}>
            {/* Logo and Title */}
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className={`${responsive.logoSize} rounded-xl flex items-center justify-center shadow-lg bg-gradient-to-r from-blue-600 to-purple-600`}>
                <span className="font-bold text-white text-lg">A</span>
            ...
            {windowWidth >= 768 && windowWidth < 1024 && (
              <nav className="absolute left-0 right-0 top-full bg-white border-b border-gray-200 shadow-sm px-6 py-2 flex items-center space-x-6 overflow-x-auto z-40">
                {mainNavItems.map((item) => (
                  <Link
                    key={item.path}
                    to={item.path}
                    onClick={handleLinkClick}
                    className={`transition-all duration-200 whitespace-nowrap flex-shrink-0 ${
                      isActive(item.path)
                        ? 'text-blue-600 font-semibold'
                        : 'text-gray-600 hover:text-blue-600'
                    }`}
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="relative group">
                ...
                {/* Dropdown Menu */}
                <div className="absolute right-0 top-full mt-2 w-48 sm:w-64 bg-white rounded-xl shadow-2xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50">
                  <div className="p-3 sm:p-4 border-b border-gray-100">
                    <p className="font-semibold text-gray-900 text-sm sm:text-base">
                      {getDisplayName()}
                    </p>
              ...
              <button
                onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                className="lg:hidden p-2 rounded-lg transition-colors duration-200 text-gray-600 hover:text-blue-600 hover:bg-gray-50 relative z-50"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  {mobileMenuOpen ? (
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
      ...
      {mobileMenuOpen && windowWidth < 768 && (
        <>
          {/* Overlay */}
          <div 
            className="fixed inset-0  bg-opacity-50 z-[45]"
            onClick={() => setMobileMenuOpen(false)}
          />
          ...
          <div className="fixed left-0 top-0 h-full w-64 bg-white shadow-xl z-50 overflow-y-auto">
            ...
            <nav className="p-4 space-y-1">
              ...
              <button 
                ...
                className="w-full flex items-center space-x-3 p-3 rounded-lg transition-all duration-200 text-gray-700 hover:bg-gray-50 hover:text-blue-600 text-left cursor-pointer"
              >
                <Icons.Profile />
                <span className="font-medium">Admin Profile</span>
              </button>
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 p-3 rounded-lg transition-all duration-200 text-red-600 hover:bg-red-50 text-left mt-2 cursor-pointer"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
      ...
      <div className={`${responsive.headerHeight}`}></div>
      
      {/* Tablet Navigation Spacer */}
      {windowWidth >= 768 && windowWidth < 1024 && (
      ...
      <main className="flex-1 relative z-10">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 min-h-[calc(100vh-15rem)] mx-4 my-4">
          <Outlet />
        </div>
      </main>

      {/* Footer */}
      <footer className="bg-[#0d1321] text-gray-300 py-6 mt-auto relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          {/* Left Text */}
          <p className="text-sm text-center md:text-left">
            © 2024 Golden Lamtouch. All rights reserved.
